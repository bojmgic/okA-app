...
const okaMotorbikeTransparent = require('../assets/vehicles/oka-motorbike-transparent.webp')
const okaTricycleTransparent = require('../assets/vehicles/oka-tricycle-transparent.webp')
