    ...
    <SafeAreaView style={styles.screen} edges={['top', 'bottom']}>
      ...
      <View style={{ marginTop: 20, gap: 10 }}>
        {documents.map((doc) => {
          ...
          return (
            <Pressable key={doc.id} onPress={() => toggle(doc.id)} style={[styles.docRow, done && styles.docRowDone]}>
...
const styles = StyleSheet.create({
  ...
  pendingScreen: { flex: 1, backgroundColor: colors.primary[900], alignItems: 'center', justifyContent: 'center', paddingHorizontal: 32 },
